...
var npmInstall = function npmInstall(airbnbConfigPkg, peerDependencies, pkgVersion) {
  ...
  console.log(_chalk["default"].green("".concat(airbnbConfigPkg, "@").concat(pkgVersion)));
  console.log();
  ...
  if (_packages["default"] && _packages["default"].length > 0) {
    console.log(_chalk["default"].green(_packages["default"].join('\n')));
  } else {
    console.log(_chalk["default"].green('No additional packages specified'));
  }

  console.log(); // debug which packages will be installed
